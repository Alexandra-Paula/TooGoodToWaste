    ...
    function O(t, b, o) {
        var l, u, s, i, a, e, c, p = window.navigator.pointerEnabled ? {
            ...
            f = window.CSS && CSS.supports && CSS.supports("touch-action", "none") && function () {
                ...
                return t
            }(), d = t, y = b.spectrum, S = [], x = [], h = [], m = 0, g = {}, v = t.ownerDocument,
            w = b.documentElement || v.documentElement, E = v.body, P = "rtl" === v.dir || 1 === b.ort ? 0 : 100;
        ...
        function N(t, e) {
            var r = C(t, b.cssClasses.origin), n = C(r, b.cssClasses.handle);
            return C(n, b.cssClasses.touchArea), n.setAttribute("data-handle", String(e)), b.keyboardSupport && (n.setAttribute("tabindex", "0"), n.addEventListener("keydown", function (t) {
                return function (t, e) {
                    ...
                    if (t.preventDefault(), p || c) {
                        var h = b.keyboardPageMultiplier, m = c ? 0 : 1, g = it(e), v = g[m];
                        if (null === v) return !1;
        ...
        function L(m) {
            ...
            }(m), v = {}, t = y.xVal[0], e = y.xVal[y.xVal.length - 1], b = !1, S = !1, x = 0;
            return (g = g.slice().sort(function (t, e) {
                return t - e
            }).filter(function (t) {
                return !this[t] && (this[t] = !0)
            }, {}))[0] !== t && (g.unshift(t), b = !0), g[g.length - 1] !== e && (g.push(e), S = !0), g.forEach(function (t, e) {
                var r, n, i, o, s, a, l, u, c, p, f = t, d = g[e + 1], h = m.mode === st.PipsMode.Steps;
        ...
        function j(t) {
            O();
            var e = L(t), r = t.filter, n = t.format || {
                to: function (t) {
        ...
        function H(i, o, s, a) {
            var e = function (t) {
                var e, r, n = function (r, t, n) {
                    var e = 0 === r.type.indexOf("touch"), i = 0 === r.type.indexOf("mouse"),
                        o = 0 === r.type.indexOf("pointer"), s = 0, a = 0;
        ...
        function n(t) {
            t.stopPropagation();
            var i, o, s, e = F(t.calcPoint), r = (i = e, s = !(o = 100), u.forEach(function (t, e) {
                if (!U(e)) {
                    var r = x[e], n = Math.abs(r - i);
                    (n < o || n <= o && r < i || 100 === n && 100 === o) && (s = e, o = n)
                }
            }), s);
            !1 !== r && (b.events.snap || ct(d, b.cssClasses.tap, b.animationDuration), Z(r, e, !0, !0), Q(), W("slide", r, !0), W("update", r, !0), W("change", r, !0), W("set", r, !0), b.events.snap && B(t, {handleNumbers: [r]}))
        }

        function X(t) {
            var e = F(t.calcPoint), r = y.getStep(e), n = y.fromStepping(r);
        ...
        function J(t, n, r, e, i) {
            var o = r.slice(), s = e[0], a = [!t, t], l = [t, !t];
        ...
        function Q() {
            h.forEach(function (t) {
                var e = 50 < x[t] ? -1 : 1, r = 3 + (u.length + e * t);
        ...
        function tt(t) {
            if (s[t]) {
                ...
                var n = r - e, i = "translate(" + G(K(e, n) + "%", "0") + ")", o = "scale(" + G(n / 100, "1") + ")";
        ...
        function it(t) {
            var e = x[t], r = y.getNearbySteps(e), n = S[t], i = r.thisStep.step, o = null;
        ...
        var ot = {
            ...
            }, target: d, removePips: O, removeTooltips: M, getTooltips: function () {
                return a
            }, getOrigins: function () {
                return u
            }, pips: j
