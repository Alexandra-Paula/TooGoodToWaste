                ...
                .authorizeHttpRequests((authorize) ->
                        authorize
                                ...
                                .requestMatchers(
                                        ...
                                        "/index", "/login/**","/forgotPassword/**", "/reset-password/**", "/blog/list",
                                        "/chat", "/about", "/privacyPolicy", "/shop", "/chat/delete/**","/termsOfUse",
                                        "/salesAndRefunds", "/faq", "/account-settings", "/shopping-cart", "/checkout",
                                        "/shop"
                                ).permitAll()
